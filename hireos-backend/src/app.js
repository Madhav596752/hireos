...
//
// CHANGE: Added interviews route registration.
//
...
import interviewsRoutes  from "./modules/interviews/interviews.routes.js"; // ← NEW
...
app.use("/api/interviews",  interviewsRoutes); // ← NEW
